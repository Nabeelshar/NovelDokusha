...
class NovelBin(
    ...
    override val id = "novel_bin"
    override val nameStrId = R.string.source_name_novel_bin
    override val baseUrl = "https://novel-bin.net/"
    override val catalogUrl = "https://novel-bin.net/sort/popular-novel-bin"
    ...
    override suspend fun getBookDescription(
        ...
        tryConnect {
            networkClient.get(bookUrl).toDocument().selectFirst(".desc-text")
                ?.let { TextExtractor.get(it) }
        }
    }
    ...
    override suspend fun getChapterList(
        ...
        tryConnect {
            ...
            val url = "https://novel-bin.net/ajax/chapter-archive"
                .toUrlBuilderSafe()
                .add("novelId", id)
                .toString()
